...
const services = [
  {
    ...
    description: "Полное преображение жилого пространства — от концепции до авторского надзора. Создаю среду, которая отражает вашу личность.",
    icon: (
  ...
  },
  {
    ...
    description: "Продуманная планировка и перепланировка пространства с учётом потоков света, зонирования и вашего образа жизни.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description: "Натуральные фактуры, авторская мебель и предметы, которые живут вместе с вами и становятся частью вашей истории.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    description: "Сопровождение проекта на всех этапах строительства и отделки. Контроль качества, сроков и точности воплощения.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
        <path
          strokeLinecap="round"
